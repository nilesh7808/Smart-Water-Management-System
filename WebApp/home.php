            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
			    ...
			    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item">
						...
						<a class="nav-link active" href="https://nilesh7808.github.io/portfolio/">Contacts</a>
                        ...
                        <?php
				            ...
				            if($_SESSION['fname']){
                                ...
                                echo '<a class="nav-link active" href="billings.php">Reciept</a>';
                                    
                                echo '</li>';

                                echo '<li class="nav-item float-right" id="logged_user">';

                                echo '<a class=" nav-link active"> '."Hi    ".$_SESSION['fname'].'</a>';
